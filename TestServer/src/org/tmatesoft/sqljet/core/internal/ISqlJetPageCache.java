...
public interface ISqlJetPageCache {
     ...
     *
     * @param szPage     Size of every page
     * @param szExtra    Extra space associated with each page
     * @param bPurgeable True if pages are on backing store
     * @param xDestroy   Called to destroy a page
     * @param xStress    Call to try to make pages clean
     */
     ...
     *
     * @param pgno       Page number to obtain
     * @param createFlag If true, create page if it does not exist already
     * @return
