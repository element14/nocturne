...
public class SqlJetEngine {
     ...
     *
     * @throws SqlJetException it is possible to get exception if there is actvie
     ...
     *
     * @param busyHandler the busy handler.
     */
     ...
     *
     * @param cacheSize the count of pages which can hold cache.
     */
