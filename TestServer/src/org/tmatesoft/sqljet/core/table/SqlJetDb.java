...
public class SqlJetDb extends SqlJetEngine {
     ...
     * </p>
     *
     * @param file     path to data base. Could be null or {@link #IN_MEMORY}.
     * @param writable if true then will allow data modification.
     */
     ...
     *
     * @param file  path to data base. Could be null or {@link #IN_MEMORY}.
     * @param write open for writing if true.
     * @throws SqlJetException if any trouble with access to file or database format.
     */
     ...
     *
     * @param sql CREATE TABLE ... sentence.
     ...
     * Alters table.
     *
     * @param sql ALTER TABLE ... sentence.
     ...
     *
     * @param sql CREATE VIRTUAL TABLE ... sentence.
     ...
     *
     * @param sql CREATE VIEW X AS SELECT ... sentence.
     ...
     *
     * @param sql CREATE TRIGGER ... sentence.
